'use strict'
const SENTIMENT = 'https://westcentralus.api.cognitive.microsoft.com/text/analytics/v2.0/sentiment'
const KEYPHRASES = 'https://westcentralus.api.cognitive.microsoft.com/text/analytics/v2.0/keyPhrases'
